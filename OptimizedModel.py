...
data = prepare_data("T-scan results/14-06-2024.csv", columns_to_keep=Columns_related_work )
target_column = 'AVI'

model, avg_mse = train_and_evaluate_model(data, target_column, 'run3', 'ExtraTreesRegressor')
